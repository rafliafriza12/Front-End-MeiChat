...
const CardProfile = () => {
    ...
    return(
        <div className=" h-screen w-[20%] flex flex-col overflow-x-hidden border-r-[2px]">
            ...
            <div className=' w-full h-[100px] bg-white flex flex-col items-center border-b-[1px]'>
            ...
            <div className=' w-full px-10 font-medium text-[#5a5a5a] flex flex-col gap-4 mt-4'>
